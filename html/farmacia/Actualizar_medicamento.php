        ...
        <div class="row">
            <div class="col-lg-12">
                <table class = "table table-striped table-hover">
                    <h1 style="text-align:center">Actualizar Medicamento</h1>
                    <tr>
                        <td>
                        ...
                        <td>Sucursal Proveedora:</td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <button name="btn-actualizar" id="btn-actualizar" class="btn btn-primary">actualizar</button> <button name="btn-cancelar" id="btn-cancelar" class="btn btn-primary">Cancelar</button>
                                </td>
                            </tr>                    
                </table>
            </div>
