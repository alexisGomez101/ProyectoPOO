...
<div id="wrapper">
        ...
        <div class="col-lg-9">
            ...
            <div id="respuesta" class="col-lg-9 well" >
                ...
                <tr>
                        <td>
                             <input type="text" name="busqueda" id="txt-busqueda"  placeholder="Codigo_Paciente" autocomplete=”on”  class="form-control">
                        </td>
                        <td>
                           ...
                           <button name="btn-buscar" id="btn-buscar"
                            ...
                            <tr>
                                <td>Codigo</td>
                                <td><input type="text" name="txt-codigo" id="txt-codigo" class="form-control" disabled="disabled"></td>
                            </tr>
                            ...
                            <tr>
                                <td>Nombres</td>
                                <td>
                                    <input type="text" name="txt-nombre" id="txt-nombre" class="form-control" disabled="disabled">
                                </td>
                            </tr>
                            <tr>
                                <td>Apellidos</td>
                                <td>
                                    <input type="text" name="txt-apellidos" id="txt-apellidos" class="form-control" disabled="disabled">
                                </td>
                            </tr>
                            <tr>
                                <td>Fecha de Nacimiento:</td>
                                <td>
                                    <input type="date" name="txt-fechaNacimiento" id="txt-fechaNacimiento" class="form-control" disabled="disabled">
                                </td>
                            </tr>
                            <tr>
                                <td>Edad:</td>
                            ...
                            <tr>
                                <td>Genero</td >
                                <td>
                                    <select name="slc-genero" id="slc-genero" class="form-control" disabled="disabled">
                    ...
                    <tr>
                        <td colspan="2">
                            <button name="btn-actualizar" id="btn-actualizar"
                            class="btn btn-primary">Actuallizar</button>
                            <button name="" id=""
